                    ...
                    <div class="columns is-multiline mb-5">
                        ...
                        <div class="column is-3">
                            ...
                            <ul class="footer-list">
                                <li><a href="../index.html" class="has-text-grey-light footer-link">Inicio</a></li>
                                <li><a href="../pages/carrito.html" class="has-text-grey-light footer-link">Carrito de Compras</a></li>
                                <li><a href="../pages/blog.html" class="has-text-grey-light footer-link">Blog / Noticias</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="column is-3">
                            ...
                            <ul class="footer-list">
                                <li><a href="../pages/login.html" class="has-text-grey-light footer-link">Iniciar Sesión</a></li>
                                <li><a href="../pages/registro.html" class="has-text-grey-light footer-link">Crear Cuenta</a></li>
                        ...
                        <div class="column is-3">
                            ...
                            <ul class="footer-list">
                                <li><a href="../pages/nosotros.html" class="has-text-grey-light footer-link">Nosotros</a></li>
                                <li><a href="../pages/contacto.html" class="has-text-grey-light footer-link">Contacto</a></li>
                            </ul>
                        </div>
